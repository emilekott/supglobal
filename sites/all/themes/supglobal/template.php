...
function supglobal_preprocess_views_view(&$vars) {
   $view = $vars['view'];
   // Make sure it's the correct view
  if($view->name == 'slideshow') {
     // add needed javascript
     drupal_add_js(drupal_get_path('theme', 'supglobal') . '/js/slider.js');
  }
}



function supglobal_form_alter(&$form, &$form_state, $form_id) {
