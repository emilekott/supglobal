...
To use these stylesheets, rename the files and supglobal with the name of your theme.
...
supglobal-alpha-default-narrow.css  
...
supglobal-alpha-default-normal.css
...
supglobal-alpha-default-wide.css
